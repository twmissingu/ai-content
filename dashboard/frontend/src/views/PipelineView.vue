...
<style scoped>
.pipeline-view { display: flex; flex-direction: column; gap: var(--space-xl); }
...
/* ── Agent Cards Grid ────────────────────────────────────────── */
.agents-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: var(--space-lg); }
.agent-card { display: flex; flex-direction: column; gap: var(--space-md); transition: all var(--transition-normal); }
...
.agent-icon { font-size: var(--text-4xl); line-height: 1; }
.agent-name { font-size: var(--text-xl); font-weight: 700; color: var(--text-primary); margin: 0; letter-spacing: -0.3px; }
.agent-worker { font-size: var(--text-xs); color: var(--text-disabled); font-family: var(--font-mono); margin-top: 2px; display: block; }

.agent-stage { display: inline-flex; align-items: center; gap: var(--space-sm); padding: var(--space-xs) var(--space-md); background: var(--primary-light); border-radius: var(--radius-full); align-self: flex-start; }
.stage-label { font-size: var(--text-xs); color: var(--primary); font-weight: 500; }
.stage-value { font-size: var(--text-xs); font-weight: 600; color: var(--primary-dark); }

.agent-progress { display: flex; align-items: center; gap: var(--space-md); }
.agent-progress .progress-bar { flex: 1; }
.progress-text { font-size: var(--text-sm); font-weight: 600; color: var(--text-secondary); min-width: 40px; text-align: right; }

.agent-detail { font-size: var(--text-sm); color: var(--text-secondary); padding: var(--space-sm) var(--space-md); background: var(--bg-hover); border-radius: var(--radius-md); border-left: 3px solid var(--primary); }

.agent-alert { display: flex; align-items: center; gap: var(--space-sm); padding: var(--space-sm) var(--space-md); border-radius: var(--radius-md); font-size: var(--text-sm); font-weight: 500; }
.alert-warning { background: var(--warning-light); color: var(--warning-dark); }
.alert-danger { background: var(--danger-light); color: var(--danger); }
.alert-message { flex: 1; }

.sub-workers { border-top: 1px solid var(--divider); padding-top: var(--space-sm); }
.sub-workers-header { margin-bottom: var(--space-xs); }
.sub-workers-label { font-size: var(--text-xs); color: var(--text-tertiary); font-weight: 500; }
.sub-workers-list { display: flex; flex-direction: column; gap: var(--space-xs); }

.sub-worker-item { display: flex; align-items: center; gap: var(--space-sm); padding: var(--space-xs) var(--space-sm); background: var(--bg-hover); border-radius: var(--radius-sm); border-left: 2px solid var(--border-color); }
...
.sub-worker-pct { font-size: var(--text-xs); color: var(--text-tertiary); min-width: 32px; text-align: right; }
...
.empty-state-icon { font-size: 64px; position: relative; z-index: 1; }
.empty-state-pulse { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 80px; height: 80px; border-radius: 50%; background: var(--primary-light); animation: pulse 2s infinite; z-index: 0; }
...
.view-all-link { font-size: var(--text-sm); color: var(--primary); text-decoration: none; font-weight: 500; }
.view-all-link:hover { text-decoration: underline; }
.pending-list { display: flex; flex-direction: column; gap: var(--space-md); }
.pending-item { display: flex; justify-content: space-between; align-items: center; gap: var(--space-lg); padding: var(--space-md); background: var(--bg-secondary); border-radius: var(--radius-md); transition: background 0.2s; }
.pending-item:hover { background: var(--bg-hover); }
.pending-info { flex: 1; min-width: 0; }
.pending-title { font-size: var(--text-md); font-weight: 600; color: var(--text-primary); margin: 0 0 var(--space-xs) 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.pending-meta { display: flex; gap: var(--space-sm); flex-wrap: wrap; }
.meta-tag { font-size: var(--text-xs); color: var(--text-tertiary); background: var(--bg-card); padding: 2px 8px; border-radius: var(--radius-sm); }
